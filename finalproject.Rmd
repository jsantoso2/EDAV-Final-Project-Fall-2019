...
Tournament Levels: \
Continental = Continental Championship Tournaments (Ex: Asian Games, African Games, etc) \
...
Note: Due to missing data, several IS + IC tournaments have been excluded from the data which does not reflect the true number of IS + IC tournaments.

This plot describes the distribution of tournaments across 2018 where we can observe that, in general, the number of tournaments that occur decreases as prestige increases. One exception to this trend is the Continental tournaments which is a separate category and occur less frequently due to its regional specificity.
